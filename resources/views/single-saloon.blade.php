...
<section id="main-container" class="main-container">
    <div class="container">
      {{-- <img src="{{ asset('/storage/2UPrDOJF4s.jpg') }}" />
      <img src="{{ Storage::path('public\2UPrDOJF4s.jpg') }}" /> --}}
      <div class="row">
        <div class="col-lg-8">
          <div id="page-slider" class="page-slider small-bg">
            @foreach ($images as $pic)
            <div class="item">
                <img loading="lazy" class="img-fluid" src="{{asset('storage/'.$pic['image'])}}" alt="saloon-image" />
              </div>
            @endforeach
          </div><!-- Page slider end -->
        </div><!-- Slider col end -->
