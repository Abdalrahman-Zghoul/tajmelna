  ...
  <div class="row card-body">
    ...
    <div class="col-md-6">
        <div class="form-group">
          ...
          <input type="file" id="image1" class="btn ms-2 text-start border d-block" name="image1" placeholder="http://----" autocapitalize="off" required>
        </div>
        <div class="form-group">
          <label for="image2">Image 2</label>
          <input type="file" name="image2" class="btn ms-2 text-start border d-block" id="image2" autocapitalize="off" placeholder="http://----">
        </div>
        <div class="form-group">
          <label for="image3">Image 3</label>
          <input type="file" name="image3" class="btn ms-2 text-start border d-block" id="image3" autocapitalize="off" placeholder="http://----">
        </div>
        <div class="form-group">
          <label for="image4">Image 4</label>
          <input type="file" name="image4" class="btn ms-2 text-start border d-block" id="image4" autocapitalize="off" placeholder="http://----">
        </div>
      </div>
      <div class="row">
